...
echo Removing file lib\cmake\libbsoncxx-3.8.0\libbsoncxx-config.cmake
del lib\cmake\libbsoncxx-3.8.0\libbsoncxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libbsoncxx-3.8.0\libbsoncxx-config-version.cmake
del lib\cmake\libbsoncxx-3.8.0\libbsoncxx-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\bsoncxx-3.8.0\bsoncxx_targets.cmake
del lib\cmake\bsoncxx-3.8.0\bsoncxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.8.0\bsoncxx_targets-debug.cmake
del lib\cmake\bsoncxx-3.8.0\bsoncxx_targets-debug.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.8.0\bsoncxx-config-version.cmake
del lib\cmake\bsoncxx-3.8.0\bsoncxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.8.0\bsoncxx-config.cmake
del lib\cmake\bsoncxx-3.8.0\bsoncxx-config.cmake || echo ... not removed
...
echo Removing file lib\cmake\libmongocxx-3.8.0\libmongocxx-config.cmake
del lib\cmake\libmongocxx-3.8.0\libmongocxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libmongocxx-3.8.0\libmongocxx-config-version.cmake
del lib\cmake\libmongocxx-3.8.0\libmongocxx-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\mongocxx-3.8.0\mongocxx_targets.cmake
del lib\cmake\mongocxx-3.8.0\mongocxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.8.0\mongocxx_targets-debug.cmake
del lib\cmake\mongocxx-3.8.0\mongocxx_targets-debug.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.8.0\mongocxx-config-version.cmake
del lib\cmake\mongocxx-3.8.0\mongocxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.8.0\mongocxx-config.cmake
del lib\cmake\mongocxx-3.8.0\mongocxx-config.cmake || echo ... not removed
...
echo Removing directory lib\cmake\bsoncxx-3.8.0
(rmdir lib\cmake\bsoncxx-3.8.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libbsoncxx-3.8.0
(rmdir lib\cmake\libbsoncxx-3.8.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libmongocxx-3.8.0
(rmdir lib\cmake\libmongocxx-3.8.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\mongocxx-3.8.0
(rmdir lib\cmake\mongocxx-3.8.0 2>NUL) || echo ... not removed (probably not empty)
...
cd ..
echo Removing top-level installation directory: C:\mongo-cxx-driver\
(rmdir C:\mongo-cxx-driver\ 2>NUL) || echo ... not removed (probably not empty)
